      ...
      <div class="summary">
        <div class="summary__install">
          ...
          <dl v-if="hasReport" class="facts">
            ...
            <div v-if="installation?.conflicts.length" class="fact fact--wide fact--paths">
              <dt>{{ t('detect.otherInstallDirs') }}</dt>
              <dd>
                <ul class="extra-installs">
                  <li v-for="path in installation.conflicts" :key="path" class="mono">
