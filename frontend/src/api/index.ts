...
export const api = {
  ...
  restoreRoot: (operationId: string, rootId: string) =>
    invoke<void>('restore_root', { operationId, rootId }),
  discardOrphanedCopy: (operationId: string, rootId: string) =>
    invoke<void>('discard_orphaned_copy', { operationId, rootId }),
